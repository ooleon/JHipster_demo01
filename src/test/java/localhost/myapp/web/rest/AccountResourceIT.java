package localhost.myapp.web.rest;

import static localhost.myapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.security.test.web.reactive.server.SecurityMockServerConfigurers.csrf;

import java.time.Instant;
import java.util.*;
import localhost.myapp.IntegrationTest;
import localhost.myapp.config.Constants;
import localhost.myapp.domain.User;
import localhost.myapp.repository.AuthorityRepository;
import localhost.myapp.repository.UserRepository;
import localhost.myapp.security.AuthoritiesConstants;
import localhost.myapp.service.UserService;
import localhost.myapp.service.dto.AdminUserDTO;
import localhost.myapp.service.dto.PasswordChangeDTO;
import localhost.myapp.service.dto.UserDTO;
import localhost.myapp.web.rest.vm.KeyAndPasswordVM;
import localhost.myapp.web.rest.vm.ManagedUserVM;
