package localhost.myapp.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof localhost.myapp.service.EmailAlreadyUsedException ||
            ex instanceof localhost.myapp.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof localhost.myapp.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "localhost.myapp");
    }
}
