...
import localhost.myapp.service.MailService;
import localhost.myapp.service.UserService;
import localhost.myapp.service.dto.AdminUserDTO;
import localhost.myapp.web.rest.errors.BadRequestAlertException;
import localhost.myapp.web.rest.errors.EmailAlreadyUsedException;
import localhost.myapp.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link localhost.myapp.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
